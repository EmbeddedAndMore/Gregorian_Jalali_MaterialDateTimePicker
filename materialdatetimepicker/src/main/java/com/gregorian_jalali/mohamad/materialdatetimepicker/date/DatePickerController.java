...
public interface DatePickerController {
    ...
    PersianCalendar[] persianGetHighlightedDays();

    PersianCalendar[] persianGetSelectableDays();

    PersianCalendar persianGetMinDate();

    PersianCalendar persianGetMaxDate();

    int getPersianMinYear();

    int getPersianMaxYear();
}
