...
public class YearPickerView extends ListView implements OnItemClickListener, DatePickerDialog.OnDateChangedListener {
    ...
    private void init() {
        if(DatePickerDialog.IsJalali()){
            mAdapter = new YearAdapter(mController.getPersianMinYear(), mController.getPersianMaxYear());
            setAdapter(mAdapter);
        }else{
    ...
    private final class YearAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            v.setTypeface(TypefaceHelper.get(context, "web_Yekan"));
            v.setText(LanguageUtils.getPersianNumbers(String.valueOf(year)));
    ...
    public void onDateChanged() {
        ...
        if(DatePickerDialog.IsJalali()){
            ...
            postSetSelectionCentered(mController.getSelectedDay().year - mController.getPersianMinYear());
        }else{
